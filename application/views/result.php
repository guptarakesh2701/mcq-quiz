        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
                ...
                <?php if ($result == 10): ?>
                    ...
                    <h3 style="margin-top: 5px; color: #ffffff;">Your all answers are correct.</h3>
                    <br>
                ...
                <?php else: ?>
                    ...
                    <h3 class="text-warning" style="margin-top: 5px; color: #ffffff;"><?php echo $result ?>/10 answers were correct.</h3>
                    <br><br>
